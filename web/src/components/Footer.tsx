    ...
    <footer className="bg-brand-primary text-white">
      <div className="container-section grid gap-8 py-12 md:grid-cols-[2fr_1fr_1fr] md:gap-12 lg:py-16">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-[#1EB457] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#1AA34E] focus-visible:bg-[#1AA34E]"
            >
        ...
        <div className="space-y-4">
          ...
          <dl className="space-y-2 text-white/85">
            <div className="flex justify-between gap-3 rounded-xl border border-white/15 bg-white/10 px-4 py-3 text-sm">
      ...
      <div className="border-t border-white/15 bg-brand-primary-700 py-4">
        <div className="container-section flex flex-col items-center justify-between gap-3 text-xs text-white/70 md:flex-row">
